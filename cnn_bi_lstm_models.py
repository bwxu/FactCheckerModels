...
def cnn_bi_lstm_model(embedding_matrix, num_words):
    # Model Definition
    model = Sequential()
    ...
    model.add(Conv1D(var.SINGLE_NUM_FILTERS,
...
def cnn_bi_lstm_model_with_subject(embedding_matrix, num_words):
...
def cnn_bi_lstm_model_with_party(embedding_matrix, num_words):
    # Create main embedding model
    main_in = Input(shape=(var.MAX_SEQUENCE_LENGTH,), dtype='int32', name='main_in')
    main_out = Embedding(input_dim=num_words + 1,
                         output_dim=var.EMBEDDING_DIM,
...
def cnn_bi_lstm_model_with_credit(embedding_matrix, num_words):
    # Create main embedding model
    main_in = Input(shape=(var.MAX_SEQUENCE_LENGTH,), dtype='int32', name='main_in')
    main_out = Embedding(input_dim=num_words + 1,
                         output_dim=var.EMBEDDING_DIM,
...
def cnn_bi_lstm_model_with_all(embedding_matrix, num_words):
    # Create main embedding model
    main_in = Input(shape=(var.MAX_SEQUENCE_LENGTH,), dtype='int32', name='main_in')
    main_out = Embedding(input_dim=num_words + 1,
                         output_dim=var.EMBEDDING_DIM,

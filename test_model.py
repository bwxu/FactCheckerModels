...
from parse_data import get_data, get_mapping, get_one_hot_vectors, \
    normalize_vectors, clean_credit, get_pos_freqs, \
    remove_stop_words
...
def test_model():
    ...
    for i, path in enumerate(paths):
        ...
        y_test = to_categorical(np.asarray(
            [var.LABEL_MAPPING[label] for label in test_labels]))
